...
The scripts and derived tables in this deposit are released under the
MIT licence (`LICENSE`). This covers the code and the tables generated by it; the
underlying GEO and TCGA datasets remain governed by their own submitter terms.
